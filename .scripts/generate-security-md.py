...
def build_markdown_report(data):
    ...
    md_content = "# Security Scan Report\n\n"
...
def main():
    """Generate markdown report from security scan JSON output."""
